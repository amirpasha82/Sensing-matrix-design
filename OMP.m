%%% Not written by Amirpasha Shirazinia.
%%% Reference: http://se.mathworks.com/matlabcentral/fileexchange/32402-cosamp-and-omp-for-sparse-recovery/content/OMP.m
...
printEvery  = setOpts( 'printEvery', 0 );
...
if ~isempty(errFcn) && slowMode && PRINT
...
if (PRINT) && (target_resid) && ( normR >= target_resid )
